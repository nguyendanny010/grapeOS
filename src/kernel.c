...
void kernel_main(){
    ...
    uint32_t * directory_entry = paging_4gb_chunk_get_directory(kernel_chunk);
    paging_set(directory_entry, (void *)0x1000, (uint32_t)ptr | PAGING_ACCESS_FROM_ALL | PAGING_IS_PRESENT | PAGING_IS_WRITEABLE);
